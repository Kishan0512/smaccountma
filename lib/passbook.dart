                            ...
                            actions: [
                              Row(mainAxisAlignment: MainAxisAlignment.end,children: [
                                ...
                                TextButton(style: ButtonStyle(backgroundColor: MaterialStateColor.resolveWith((states) => Colors.purple.shade900)),onPressed: ()  {
                                  c.insert_transaction(t1.text, t2.text, c.gvalue.value, t3.text, widget.a.id!);
                                  t1.text="";
                                  t2.text="";
                                  t3.text="";
                                  Navigator.pop(context);
                        ...
                        showDialog(context: context, builder: (context) {
                          return SimpleDialog(
                            children: [
                              TextButton(onPressed: () {
                                ...
                                showDialog(context: context, builder: (context) {
                                  return AlertDialog(
                                      ...
                                      actions: [
                                        TextButton(onPressed: ()   {
                                          c.update_transaction(t1.text, t2.text, c.gvalue.value, t3.text, t.id,widget.a.id!);
                                          t1.text="";
                                          t2.text="";
                                          t3.text="";
                                          Navigator.pop(context);
                              ...
                              TextButton(onPressed: () {
                                c.delete_transaction(t.id, widget.a.id!);
                                Navigator.pop(context);
                              }, child: Text("Delete")),
                            ],
                          );
